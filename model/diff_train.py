...
class VAE(nn.Module):
    def __init__(self, input_dim, hidden_dim, latent_dim,input_options=[4784,6143],Sigmoid=1):
        ...
        self.lin1=nn.Linear(input_options[0],hidden_dim)
        self.lin2=nn.Linear(input_options[1],hidden_dim)
...
def normal_train_diff(model,
    ...
    if decoder_train==1:
        ...
        encoder_params = list(filter(lambda p: p.requires_grad, vae.encoder.parameters()))
