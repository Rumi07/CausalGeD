...
class CausalDiffusionModel(nn.Module):
    def __init__(
        ...
        self.y_embedder=nn.Linear(input_size**2,self.num_cond_tokens*hidden_size)
    ...
    def forward(self, xn, t, x, y, attn_mask, last_split_size, noise):
        ...
        y_embed = self.y_embedder(y).reshape(N, self.num_cond_tokens, D)
...
def CausalFusion_L(**kwargs):
    return CausalDiffusionModel( hidden_size=1024, patch_size=1, latent_channels=1, num_heads=16, 
